classdef hypothesisReduction
    ...
    methods (Static)
        function [hypothesesWeight, multiHypotheses] = ...
            ...
            %       1 structure  
            % get indicator of qualified hypotheses:
            I = (hypothesesWeight >= threshold);
            % prune:
            hypothesesWeight = hypothesesWeight(I);
            multiHypotheses = multiHypotheses(I);            
        end
        ...
        function [hypothesesWeight, multiHypotheses] = ...
            ...
            %       1 structure 
            % get indicator of qualifed hypotheses:
            [~, I] = maxk(hypothesesWeight, M);
            % cap:
            hypothesesWeight = hypothesesWeight(I);
            multiHypotheses = multiHypotheses(I);           
        end
